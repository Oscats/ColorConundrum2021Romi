...
public class FindNewTrajectoryRuntime extends CommandBase {
  ...
  public FindNewTrajectoryRuntime(Trajectory trajectory, Drivetrain drivetrain, Waypoints waypoints) {
  ...
  public void execute() {
    ...
    new Rotation2d(SmartDashboard.getNumber("Start PoseAngle(in Degrees)", 0))),
        waypoints = List.of(
          new Translation2d(Units.inchesToMeters(SmartDashboard.getNumber("PointX", 0)),
          Units.inchesToMeters( SmartDashboard.getNumber("PointY", 0)))
        ),
